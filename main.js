...
// Get all active sub-instances from DB
...
app.post('/api/upload', verifyToken, async (req, res) => {
  try {
    ...
    // Get space from all sub-instances
    ...
    // Upload to primary sub-instance
    ...
    // Queue replication to backup sub-instance (async)
...
app.get('/api/files', verifyToken, async (req, res) => {
  try {
    ...
    // Get signed URLs from sub-instances
